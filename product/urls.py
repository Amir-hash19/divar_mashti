...
from .views import ProductListView, ProductCreateView, ProductRetrieveView, ProductDestroyView, OrderDeleteView, CreateOrderView, OrderRetrieveView, UpdateProductView
